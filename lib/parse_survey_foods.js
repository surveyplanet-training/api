...
<<<<<<< HEAD:lib/parseSurveyFoods.js
		...
		code: data.description
			...
			.trim()
			.replace(/[,()]/g, '')
			.replace(/[\s\/\\]/g, '-'), // 'Milk, Human' -> 'milk-human'
=======
		code: slugify(data.description, {lower: true, strict: true}), // 'Milk, Human' -> 'milk-human'
>>>>>>> origin/luka:lib/parse_survey_foods.js
		protein: {},
		lipids: {},
		carbohydrates: {},
		energy: {},
